(function() {
    ...
    angular
    .module('myApp.service.country')
    .factory('countryHelper', CountryHelper);

    CountryHelper.$inject = [];

    function CountryHelper() {

        var countries = [
            {"name": "Afghanistan", "alpha2": "AF", "alpha3": "AFG", "numeric": "004"},
            {"name": "Ã…land Islands", "alpha2": "AX", "alpha3": "ALA", "numeric": "248"},
            ...
            {"name": "CÃ´te d'Ivoire", "alpha2": "CI", "alpha3": "CIV", "numeric": "384"},
            {"name": "Croatia", "alpha2": "HR", "alpha3": "HRV", "numeric": "191"},
            {"name": "Cuba", "alpha2": "CU", "alpha3": "CUB", "numeric": "192"},
            {"name": "CuraÃ§ao", "alpha2": "CW", "alpha3": "CUW", "numeric": "531"},
            ...
            {"name": "RÃ©union", "alpha2": "RE", "alpha3": "REU", "numeric": "638"},
            ...
            {"name": "Saint BarthÃ©lemy", "alpha2": "BL", "alpha3": "BLM", "numeric": "652"},
